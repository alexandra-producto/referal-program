...
async function GET(request, { params }) {
    try {
        ...
        const { data: hyperconnector, error } = await supabase.from("hyperconnectors").select("id, full_name, email, candidate_id").eq("candidate_id", candidateId).maybeSingle();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2aa2fbf6._.js.map