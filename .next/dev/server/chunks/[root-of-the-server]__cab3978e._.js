...
"[project]/Referal MVP/app/api/hyperconnector/by-candidate/[candidateId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: hyperconnector, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("hyperconnectors").select("id, full_name, email, candidate_id").eq("candidate_id", candidateId).maybeSingle();
        if (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(hyperconnector);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cab3978e._.js.map