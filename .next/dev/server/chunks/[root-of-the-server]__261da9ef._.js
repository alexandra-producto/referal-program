...
"[project]/Referal MVP/src/domain/recommendations.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Referal MVP/src/db/supabaseClient.ts [app-route] (ecmascript)");
;
async function getRecommendationsForJob(jobId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("recommendations").select("*").eq("job_id", jobId);
    if (error) throw error;
    return data;
}
async function createRecommendation(payload) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("recommendations").insert(payload).select().single();
    if (error) throw error;
    return data;
}
async function updateRecommendation(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("recommendations").update(updates).eq("id", id).select().single();
    if (error) throw error;
    return data;
}
async function deleteRecommendation(id) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$db$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("recommendations").delete().eq("id", id);
    if (error) throw error;
    return true;
}
}),
"[project]/Referal MVP/app/api/recommend/[token]/submit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$domain$2f$recommendations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Referal MVP/src/domain/recommendations.ts [app-route] (ecmascript)");
;
;
;
async function POST(request, { params }) {
    try {
        ...
        if (candidateIds && candidateIds.length > 0) {
            const candidateRecommendations = await Promise.all(candidateIds.map((candidateId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$domain$2f$recommendations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRecommendation"])({
                    hyperconnector_id: hyperconnectorId,
                    job_id: jobId,
        ...
        if (linkedinUrl) {
            const customRecommendation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$domain$2f$recommendations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRecommendation"])({
                hyperconnector_id: hyperconnectorId,
                job_id: jobId,
                candidate_id: null,
                notes: notes || null,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$src$2f$domain$2f$recommendationLinks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["markRecommendationLinkAsUsed"])(token);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Referal__MVP$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            recommendations,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__261da9ef._.js.map